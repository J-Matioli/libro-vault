...
const routes: Routes = [
  ...
  { path: 'estantes', loadChildren: () => import('./features/shelf/shelf.module').then(m => m.ShelfModule) },
  { path: 'hqs', loadChildren: () => import('./features/hqs/hqs.module').then(m => m.HqsModule) },
